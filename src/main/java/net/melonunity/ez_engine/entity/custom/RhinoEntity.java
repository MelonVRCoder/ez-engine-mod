package net.melonunity.ez_engine.entity.custom;

import net.melonunity.ez_engine.entity.ModEntities;
import net.melonunity.ez_engine.entity.ai.RhinoAttackGoal;
...
public class RhinoEntity extends Animal {
    ...
    private void setupAnimationStates() {
        ...
        if (this.isAttacking() && attackAnimationTimeout <= 0) {
            attackAnimationTimeout = 80; //lengt of ticks in animation jdnwiadi8 :3
